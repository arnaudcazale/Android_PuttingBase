 ...
 */
@Entity(tableName = "Euler", foreignKeys = [
    (ForeignKey(entity = Session::class,
            parentColumns = ["id"],
            childColumns = ["session_id"],
            onDelete = CASCADE))])
class EulerModel(@ColumnInfo(name = "DeviceAddress") var deviceAddress: String = "",
                 ...
                 @ColumnInfo(name = "Angle_X1_X2") var angleX1X2: Float = 0f,
